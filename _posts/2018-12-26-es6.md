...
layout: post
title: ECMAScript 6
subtitle: Tiêu chuẩn mới của JavaScript - ES2015 trở lên
gh-repo: thaycacac/thaycacac.github.io
gh-badge: [follow]
categories: [code]
tags: [javascript]
description: ES6 là chữ viết tắt của ECMAScript 6, là phiên bản mới nhất của chuẩn ECMAScript. ECMAScript do hiệp hội các nhà sản xuất máy tính Châu Âu đề xuất làm tiêu chuẩn của ngôn ngữ Javascript.
keywords: [
  es6 là gì,
  es6 tutorial,
  typescript va es6,
