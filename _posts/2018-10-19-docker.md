...
layout: post
title: Docker
subtitle: Tìm kiểu về docker
gh-repo: thaycacac/thaycacac.github.io
gh-badge: [follow]
categories: [code]
tags: [docker]
description: Docker là một open platform cung cấp công cụ và service để đóng gói và chạy chương trình của mình trên các môi trường khác nhau một cách nhanh nhất. Bài viết này chúng ta cùng nhau tìm hiểu docker là gì, tạo sao cần dùng docker nhé.
keywords: [
  docker là gì,
  docker tutorial,
  docker 1 gio,
